        ...
        <div className="flex items-center gap-6">
          {links.map((link, idx) => (
            <Link
              ...
              className="p-3 bg-white rounded-full text-orange-600 shadow-sm hover:shadow-md hover:bg-orange-50 transition-all duration-300 hover:-translate-y-1"
              onClick={() => trackEvent(`${link.platform.toLowerCase()}-click`, "socials")}
